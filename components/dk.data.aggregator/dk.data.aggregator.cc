...
bool dk_data_aggregator::on_init(){
    console::info("<{}> call dk_data_aggregator on_init", _THIS_COMPONENT_);
...
void dk_data_aggregator::on_loop(){
    console::info("<{}> call dk_data_aggregator on_loop", _THIS_COMPONENT_);
...
void dk_data_aggregator::on_close(){
    console::info("<{}> call dk_data_aggregator on_close", _THIS_COMPONENT_);
}

void dk_data_aggregator::on_message(){
    console::info("<{}> call dk_data_aggregator on_message", _THIS_COMPONENT_);
}
