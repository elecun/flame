...
bool dk_presdd_inference::on_init(){
    console::info("<{}> call dk_presdd_inference on_init", _THIS_COMPONENT_);
...
void dk_presdd_inference::on_loop(){
    console::info("<{}> call dk_presdd_inference on_loop", _THIS_COMPONENT_);
...
void dk_presdd_inference::on_close(){
    console::info("<{}> call dk_presdd_inference on_close", _THIS_COMPONENT_);
}

void dk_presdd_inference::on_message(){
    console::info("<{}> call dk_presdd_inference on_message", _THIS_COMPONENT_);
}
