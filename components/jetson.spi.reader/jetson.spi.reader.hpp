/**
 * @file jetson.spi.reader.hpp
 * @author Byunghun Hwang(bh.hwang@iae.re.kr)
 * @brief ADC data reader from SPI on Jetson Xavier NX
 * @version 0.1
 * @date 2023-08-16
 * 
...
#ifndef _FLAME_COMPONENT_JETSON_SPI_READER_HPP_
#define _FLAME_COMPONENT_JETSON_SPI_READER_HPP_

#include <flame/core.hpp>
#include <3rdparty/device/spi.hpp>
...
class jetson_spi_reader : public core::task::runnable_rt{

    public:
        jetson_spi_reader() = default;
        ~jetson_spi_reader() = default;
